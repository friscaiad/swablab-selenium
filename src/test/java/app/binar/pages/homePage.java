...
public class homePage {
    ...
    private static WebElement burger_icon;

    @FindBy(id = "about_sidebar_link")
    private static WebElement about_menu;

    @FindBy(xpath = "//span[@class='title']")
    private static WebElement access_about;
    ...
    public static void TapBurgerButton() {
        keyword.tapElement(burger_icon);
    }

    public static void TapAboutMenu() {
        keyword.tapElement(about_menu);

    }
    public static void verifySuccessAboutPage() {
        keyword.validate_element_is_visible_and_enabled(access_about);
    }
